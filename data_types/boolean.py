...
""" related functions (the return value is boolean), such as, is, is not, in, not in etc.
built-in funcitons: isinstance, issubclass
string methods, isslnum, isalpha, isdecimal, isdigit, islower, isupper, isspace, istitle......, start with is***. 
"""
D = 'abcdef'
print(12, 'a' in D)
print(13, 'h' not in D)
...
object.__lt__(self, other)  __le, __eq__, __ne__, __gt__, __ge__,
