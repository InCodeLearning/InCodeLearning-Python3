...
# Array can only contain same type items, mostly numbers as numpy array, to handle large data sets efficiently
# list is mutable
...
print(hex(id(l)))   # 0x2564cb0  print the memory address of list l, it will be different for different operator.
print(len(l))   # 7
# list index
...
# slicing
print(l[:5])   # [True, 2, 3.5, 5-8j, [9, 7, 5]], not including the second slice index
print(l[4:-1])  # [[9, 7, 5], 'python'], can be combination of reasonable positive and negative index
print(l[4:-6])  # [], if the second slice index on the left of the first one, return to empty list
print(l[6:3])   # [], same reason as above one

# method
l.append([1, 2, 3])  # add a sublist
print(l)  # [True, 2, 3.5, (5-8j), [9, 7, 5], 'python', ('a', 2), [1, 2, 3]]

l.extend([4, 5, 'a'])  # add three numbers
print(l)    # [True, 2, 3.5, (5-8j), [9, 7, 5], 'python', ('a', 2), [1, 2, 3], 4, 5, 'a']

l.insert(0, 'a')  # assign item to specific position
print(l)  # ['a', True, 2, 3.5, (5-8j), [9, 7, 5], 'python', ('a', 2), [1, 2, 3], 4, 5, 'a']

print(l.count('a'))  # 2, return the number that how many items that item shows in the list
...
print(l)  # [True, 2, 3.5, (5-8j), [9, 7, 5], 'python', ('a', 2), [1, 2, 3], 4, 5]
...
# print(l.sort())  TypeError: unorderable types: list() < float(), l.sort() should be used in homogeneous type list
l.pop(3)  # remove the assigned index item, l.pop(1) or l.pop([1])
l.pop(-3)
print(l)  # [True, 2, 3.5, 'python', ('a', 2), 4, 5]
...
l.reverse()
print(l)  # [5, 4, ('a', 2), 'python', 3.5, 2, True]

l_new = l.copy()
l_new2 = l[:]
print(l_new, l_new2, hex(id(l)), hex(id(l_new)), hex(id(l_new2)))
# [5, 4, ('a', 2), 'python', 3.5, 2, True], [5, 4, ('a', 2), 'python', 3.5, 2, True] memory addresses are different.
